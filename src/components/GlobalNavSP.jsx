          ...
          <div className="sp-sheet-reveal relative z-10 flex max-h-[inherit] flex-col">
            ...
            <div className="mb-4 flex w-full shrink-0 justify-center pt-4">
              <div className="relative h-[6px] w-[56px] rounded-full bg-white/14">
                <span className="absolute left-1/2 top-1/2 h-[3px] w-[28px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-200/44" />
              </div>
            </div>

            {/* header */}
            <div className="mb-4 shrink-0 px-5">
              <div className="relative overflow-hidden rounded-[22px] border border-white/10 bg-[rgba(8,18,38,0.74)] px-4 py-4">
                ...
                <div className="pointer-events-none absolute left-0 top-0 h-full w-[88px] bg-gradient-to-r from-cyan-300/10 to-transparent blur-2xl" />

                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0">
                    <div className="flex items-center gap-2">
                      <span className="h-[5px] w-[5px] rounded-full bg-cyan-300 shadow-[0_0_10px_rgba(103,232,249,0.46)]" />
                      <p className="text-[10.5px] tracking-[0.30em] text-cyan-200/88">
                        SINGULARITY LAB
                      </p>
                    </div>
...
function NavItemSP({ label, meta, to, active, onMove, index = 0 }) {
  const accents = [
    {
      ...
      >
        <div
          className={`
            ...
            ${active ? accent.glow : "from-white/[0.04]"}
          ...
          <div className="min-w-0">
            ...
            <p
              className={`
                ...
                ${active ? accent.meta : "text-white/34"}
              `}
            >
              {meta}
            </p>
        ...
        {active && (
          <span
            className={`pointer-events-none absolute bottom-[2px] left-1/2 h-[1px] w-[76%] -translate-x-1/2 ${accent.line}`}
          />
        )}
      </div>
    </button>
