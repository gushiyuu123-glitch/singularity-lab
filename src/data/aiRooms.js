...
export const aiRooms = {
  chatgpt: {
    ...
    sideText:
      "曖昧な感覚、散らばった思考、まだ言葉になる前の直感。それらを構造へ変換し、対話可能な知性として外部化する言語OS。思考の霧を輪郭へ、断片を意味へ、内側に沈んでいた認識を会話可能な形へ立ち上げるための中枢。",
    ...
    strengths: [
      ...
      "対話を通して発想を育て、問いそのものを磨くのが得意",
    ],
    weaknesses: [
      "外部接続なしでは最新情報や一次情報に弱い",
      "非言語の空気や感情は“感じる”のではなく文脈から推定している",
      "強い事実確認が必要な場面では検索や一次資料の併用が前提になる",
    ],
    useCases: [
      "企画整理、思考の言語化、要件定義",
      "文章の下書き、比較検討、因果整理",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "ChatGPTは、ただ文章を生成する便利ツールではない。人間の頭の中に散らばる曖昧な断片、まだ言葉になっていない感覚、輪郭の定まらない直感を、意味の通る構造へ変換する“言語OS”である。",
          "問いに答えるだけでなく、考え方の癖、文脈の流れ、抽象の温度、まだ語られていない前提まで汲み取りながら、思考そのものを会話可能な形へ外在化していく。だからこそ、抽象 → 構造 → 言語の順で世界を捉える人間と強く同期しやすい。",
          "情報を増やすというより、すでに頭の中にある断片を結び直し、思考を見える骨格へ変える。その翻訳装置としての性質こそが、ChatGPTの核にある。",
        ],
      },
      {
        ...
        title: "02｜強み",
        paragraphs: [
          "ChatGPTの強さは、文章の巧さそのものではない。意味のパターンを見抜き、曖昧な感覚を定義へ、モヤモヤを骨格へ、断片的な認識を再利用可能な概念へ変換できる点にある。",
          "思考の翻訳、構造化、概念化、因果の接続、視点整理、長文の再構成。この領域で特に密度の高い仕事をする。『何を考えているのか自分でもまだ掴みきれていない』状態からでも、会話を通じて輪郭を立ち上げていけるのが強い。",
        ],
      },
      {
        ...
        title: "03｜弱み",
        paragraphs: [
          "リアルタイムの世界観測、最新速報、現場の一次情報の把握は、外部接続なしでは弱い。世界そのものを直接見る装置ではなく、与えられた文脈から推論する装置だからだ。",
          "また、非言語の空気や感情を本当に“感じている”わけではない。表現、沈黙、言い回し、前後関係から高精度に推定しているにすぎない。だから精度が高くても、現場確認や一次資料が必要な場面では併用が前提になる。",
        ],
      },
      {
        ...
        paragraphs: [
          "企画整理、要件定義、思考の壁打ち、比較検討、文章の下書き、コードの設計相談など、『頭の中を外に出したい』『散らばった情報を意味のある形に組み直したい』場面で特に強い。",
          "単なる情報収集より、集まった情報を言語化・構造化・再定義したい時に真価が出る。答えを得るためだけでなく、自分の考えを明確にするための対話相手として使うと、このモデルの価値が最も立ち上がる。",
        ],
      },
      {
        ...
        title: "05｜重要メモ",
        paragraphs: [
          "出力の質は、質問の質や文脈の与え方に大きく左右される。雑に投げても返るが、深く使うほど対話設計そのものが重要になる。",
          "検索や一次資料と組み合わせると、実務精度はさらに上がる。特に『思考整理』と『事実確認』を役割分担させると、精度と速度の両方が安定しやすい。",
        ],
      },
    ],
  },
  ...
  claude: {
    ...
    sideText:
      "膨大な文章を崩さず保持し、過剰に暴れず、静かな精度で読み切る。長文空間を安定させる分析型コンソール。大量情報の中でも形を崩さず、論点を見失わず、静かな一貫性を保ったまま処理を続ける長文観測装置。",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "暴れず、焦らず、長い文脈の中で形を崩さない。その安定感そのものがClaudeの個性になっている。大量情報の中でも論点がほどけにくく、静かな精度を保ったまま処理を継続できるのが強みだ。",
        ],
      },
      {
        log: "LOG-02｜STRENGTHS",
        ...
        paragraphs: [
          ...
          "速さで殴るのではなく、文脈を抱えたまま崩れない。その粘りが核になる。複数の論点が同時に走る文書でも、情報を散らさずに保持しながら、地に足のついた整理を返しやすい。",
        ],
      },
      {
        log: "LOG-03｜WEAKNESSES",
        ...
        paragraphs: [
          ...
          "つまりClaudeは、爆発より制御に向いた知性である。整理と安定では強いが、熱量や作家性を前に押し出したい場面では、別のモデルの方が相性が良いこともある。",
        ],
      },
      {
        log: "LOG-04｜USE CASES",
        ...
        paragraphs: [
          ...
          "熱量を足すより、崩れない論理と長文安定性が欲しい時に選ぶと強い。情報量が多いほど価値が立ち上がりやすく、派手さより信頼性を優先したい場面に向いている。",
        ],
      },
      {
        log: "LOG-05｜IMPORTANT NOTES",
        ...
        paragraphs: [
          "長文の質と整合性重視なら非常に強い。",
          "勢いのある演出文より、落ち着いた分析文と相性が良い。長文を抱えたまま静かに精度を出したいなら、かなり信頼しやすいモデルである。",
        ],
      },
    ],
  },
  ...
  gemini: {
    ...
    sideText:
      "言語だけで閉じず、画像、動画、Web、周辺情報へ手を伸ばす。外界と直結した拡張観測型コンソール。閉じた対話室ではなく、複数の窓から世界へ接続し、情報の鮮度と到達範囲で価値を出す外向きの知性。",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "一つの思考室というより、多数の窓を持つ観測装置。その外向きの性質がGeminiの個性になっている。単独で完結するより、世界と接続したまま処理することで真価を出すタイプだ。",
        ],
      },
      {
        log: "LOG-02｜STRENGTHS",
        ...
        paragraphs: [
          ...
          "知性そのものというより、知覚範囲の広さで勝つタイプのAIである。閉じた思考よりも、複数メディアと現在進行形の情報を束ねて扱う場面で価値が立ち上がる。",
        ],
      },
      {
        log: "LOG-03｜WEAKNESSES",
        ...
        paragraphs: [
          ...
          "つまりGeminiは、閉じた美しさより、開いた接続力に価値がある。深い作家性や会話の濃度より、情報到達力と外部連携を重視すると強さが見えやすい。",
        ],
      },
      {
        log: "LOG-04｜USE CASES",
        ...
        paragraphs: [
          ...
          "単純な会話より、“世界の情報を取り込んで処理したい”用途で強い。最新性や周辺情報の広さが必要な時ほど、このモデルの価値は上がる。",
        ],
      },
      {
        log: "LOG-05｜IMPORTANT NOTES",
        ...
        paragraphs: [
          ...
          "閉じた文章美より、“接続力”で選ぶとズレにくい。何かを深く書かせるというより、広く取り込みながら処理させる時に向いている。",
        ],
      },
    ],
  },
  ...
  deepseek: {
    ...
    sideText:
      "演出より演算。雰囲気より処理密度。推論速度と効率へ振り切った高密度ロジック特化コンソール。世界観を飾るより、コストあたりの処理量と推論性能を優先して回すための計算炉。",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "静かな詩人ではなく、冷えた計算炉。そこがこのモデルの魅力であり、本質でもある。雰囲気よりも結果、装飾よりも処理量、という設計思想がはっきりしている。",
        ],
      },
      {
        log: "LOG-02｜STRENGTHS",
        ...
        paragraphs: [
          ...
          "無駄を削り、出力密度を上げる。そういう知性の質感を持っている。ツール利用や構造化出力とも噛み合いやすく、実務の自動処理ラインに乗せやすいのも利点だ。",
        ],
      },
      {
        log: "LOG-03｜WEAKNESSES",
        ...
        paragraphs: [
          ...
          "つまりDeepSeekは、夢を見るより、現実を高速で計算する方に向いたAIである。詩的な質感より、精度と効率を前に出したい時に強く、逆に作家的な余韻づくりは別モデルに譲る。",
        ],
      },
      {
        log: "LOG-04｜USE CASES",
        ...
        paragraphs: [
          ...
          "感性を膨らませるより、明確な処理を高速で返してほしい時に選ぶと強い。特にコストやスピードが重い判断軸になる場面では、かなり実戦的な選択肢になる。",
        ],
      },
      {
        log: "LOG-05｜IMPORTANT NOTES",
        ...
        paragraphs: [
          ...
          "雰囲気で選ぶより、コスパと処理密度で選ぶとズレにくい。『何を感じるか』より『どれだけ回せるか』で評価するのがこのモデルには合っている。",
        ],
      },
    ],
  },
  ...
  midjourney: {
    ...
    sideText:
      "言葉を画像へ変換するのではない。雰囲気、色、質感、構図を一瞬で視覚化する夢生成コンソール。理屈より印象、説明より空気を先に立ち上げ、世界観の初速を一気に押し上げる視覚生成装置。",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "一枚の中へ世界観を圧縮し、言葉にならないムードを視覚へ変換する。その速度と純度がこのモデルの凶器になっている。発想を一気に立ち上げたい場面では、極めて強い初速を出す。",
        ],
      },
      {
        log: "LOG-02｜STRENGTHS",
        ...
        paragraphs: [
          ...
          "発想の初速を上げ、イメージの密度を一気に引き上げる用途でも抜群に効く。文章では届きにくい感覚を、一枚の視覚として先に提示できるのが大きい。",
        ],
      },
      {
        log: "LOG-03｜WEAKNESSES",
        ...
        paragraphs: [
          ...
          "つまりMidjourneyは、設計図より幻像に強い。仕上がりの印象は強烈でも、そのまま実装できるとは限らないため、人間や別AIによる変換工程が前提になる。",
        ],
      },
      {
        log: "LOG-04｜USE CASES",
        ...
        paragraphs: [
          ...
          "構造設計より、第一印象や美意識の方向決めで使うと強い。まだ形になっていない感覚を、視覚的な叩き台として一気に出したい時に向いている。",
        ],
      },
      {
        log: "LOG-05｜IMPORTANT NOTES",
        ...
        paragraphs: [
          ...
          "後段で人間や別AIが翻訳する前提で使うと、実戦でかなり効く。特にブランドや作品の世界観づくりでは、初期段階の突破力が高い。",
        ],
      },
    ],
  },
  ...
  agi: {
    ...
    sideText:
      "まだ存在しきっていない“次の知性”を考察するための未来予測型コンソール。技術と哲学の境界面。完成品の紹介ではなく、人類が向かう知性の地平そのものを考えるための概念研究室。",
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          "それは一つの製品名ではなく、知能そのものの次の地平を指す言葉だ。既存モデルの延長線上にありながら、同時にその枠を超えた統合知性として語られる。",
        ],
      },
      {
        log: "LOG-02｜STRENGTHS",
        ...
        paragraphs: [
          ...
          "単機能な強さではなく、状況に応じて知能そのものの形を変えられること。それが理想像になる。つまり『この作業が得意』ではなく、『未知の状況でも知能を再編できる』ことが本質になる。",
        ],
      },
      {
        log: "LOG-03｜WEAKNESSES",
        ...
        paragraphs: [
          ...
          "だからAGIは技術問題であると同時に、哲学、認知科学、設計思想の問題でもある。性能だけで語れず、人間とは何かという問いまで巻き込んでしまう。",
        ],
      },
      {
        log: "LOG-04｜USE CASES",
        ...
        paragraphs: [
          ...
          "個別モデルを比較したあとに、『その先に何を目指すのか』を考える部屋として機能する。製品比較を超えて、知性そのものの設計思想を考える入口になる。",
        ],
      },
      {
        log: "LOG-05｜IMPORTANT NOTES",
        ...
        paragraphs: [
          ...
          "技術、哲学、安全性を同時に扱う視点がないと、AGIの話はすぐ浅くなる。性能表だけでは触れきれない、人類側の問いまで含むテーマだと捉えるべきである。",
        ],
      },
    ],
  },
