...
export const aiRooms = {
  chatgpt: {
    ...
    sideText:
      "曖昧な感覚、散らばった思考、言葉になる前の直感。それらを構造へ変換し、会話可能な知性として外部化する対話OS。思考の霧を輪郭へ変え、断片を意味へつなぎ、内側にあるまだ不完全な認識を言語として成立させるための中枢。",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "ChatGPTは、ただ文章を生成する便利ツールではない。人間の頭の中に散らばる曖昧な断片、まだ言葉になっていない感覚、輪郭の定まらない直感を、意味ある構造へ変換する“言語OS”である。",
          "問いに答えるだけでなく、考え方の癖、文脈の流れ、抽象の温度、語られていない前提まで汲み取りながら、思考そのものを会話可能な形へ外在化していく。だからこそ、抽象 → 構造 → 言語の順で世界を捉える人間と強く同期しやすい。",
          "情報を増やすというより、すでに頭の中にある断片を結び直し、思考を見える骨格へ変える。その“翻訳装置”としての性質こそが、ChatGPTの核にある。",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "思考の翻訳、構造化、概念化、因果の接続、視点整理、長文の再構成。このあたりで特に密度の高い仕事をする。『何を考えているのか自分でもまだ掴みきれていない』状態からでも、会話を通じて輪郭を立ち上げていけるのが強い。",
        ],
      },
      {
        ...
        paragraphs: [
          ...
          "また、非言語の空気や感情を本当に“感じている”わけではない。表現、沈黙、言い回し、前後関係から高精度に推定しているにすぎない。だから高精度でも、現場確認や一次資料が必要な場面では併用が前提になる。",
        ],
      },
      {
  ...
  claude: {
    ...
    sideText:
      "膨大な文章を崩さず保持し、過剰に暴れず、静かな精度で読み切る。長文空間を安定させる分析型コンソール。大量情報の中でも形を崩さず、論点を見失わず、静かな一貫性を保ちながら処理を続ける長文観測装置。",
